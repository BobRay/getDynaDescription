...
$output = "<p style=\"width:50%\">The getDynaDescription snippet will allow you to create description Meta tags by placing a tag in your template(s). The snippet can use the value of the dynaDescription Template variable, the description resource field, or the beginning of the resource content for the Meta tag.</p><br />

<p style=\"width:50%\">If you would like to have the dynaDescription template variable created automatically and attached to any of your templates, check the appropriate boxes below. If you plan to use the resource description field or the resource content, you won't need the TV.</p><br />";


$output .= '<fieldset style="padding:15px;margin:0px;width:50%;"><input type="checkbox" name="createTv" value="CreateDescriptionTv"><legend>&nbsp;&nbsp;Create TV&nbsp;&nbsp;</legend>&nbsp;&nbsp;Create dynaDescription template variable<br /><br />';
...
$output .= '<br /><p  style="width:50%">If you want a snippet tag inserted in the &lt;head&gt; section of the selected templates (be sure you have checked the templates above) select the desired option below:</p><br />';

$output .= '<fieldset style="padding:15px; margin:0px;width:50%;"><input type="radio" checked="checked" name="doTag" value="no"><legend>&nbsp;&nbsp;Tag Style&nbsp;&nbsp;</legend>&nbsp;&nbsp;No (other options will be ignored)<br />';
...
$output .= '<fieldset style="padding:15px;margin:0px;width:50%;"><legend>&nbsp;&nbsp;Options&nbsp;&nbsp;</legend><input type="checkbox" name="fullTag" value="fullTag">&nbsp;&nbsp;Create Full Tag (adds &amp;fullTag=`1` to the snippet tag to create the entire Meta tag instead of just the description part)<br /><br />';
